/**
 * uicc.access.fileadministration package, getTheAdminFileView tests
 * applet 1
 */

package uicc.test.access.fileadministration.api_4_afb_gtafob;
...
public class Api_4_Afb_Gtafob_1 extends TestToolkitApplet implements UICCConstants {
    ...
    private byte[]         abAdf1Aid        = new byte[16];
    private static AID     adf1AidTmp       = null;
    private AID            adf1Aid          = null;
    private byte[]         abUnknownAid     = {(byte)'U',(byte)'n',(byte)'k',(byte)'n',(byte)'o',(byte)'w',(byte)'n',(byte)'A',(byte)'I',(byte)'D'};
    private AID            unknownAid       = new AID( abUnknownAid, (short) 0, (byte) 10);
    ...
    public Api_4_Afb_Gtafob_1() {
        ...
        Util.arrayCopyNonAtomic(uiccTestConstants.AID_ADF1, (short) 0, abAdf1Aid, (short) 0,
                (short) abAdf1Aid.length);
        adf1AidTmp = new AID(abAdf1Aid, (short) 0, (byte) abAdf1Aid.length);
        adf1Aid = adf1AidTmp;
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        ...
        Api_4_Afb_Gtafob_1 thisApplet = new Api_4_Afb_Gtafob_1();
        ...
        try {
            bRes1 = (AdminFileViewBuilder.getTheAdminFileView(adf1AidTmp, JCSystem.CLEAR_ON_RESET) == null);
            adf1AidTmp = null;
        }
        catch(Exception e) {
            bRes1 = false;
    ...
    public void process(APDU apdu) {
        if (selectingApplet()) {
            ...
            case 1:
                ...
                try {
                    adminFileView_3 = AdminFileViewBuilder.getTheAdminFileView(adf1Aid, JCSystem.CLEAR_ON_DESELECT);
            ...
            case 3:
                ...
                if (transientAvailable < (short)0x7FFF)
                {
                    ...
                    try {
                        AdminFileViewBuilder.getTheAdminFileView(adf1Aid, JCSystem.CLEAR_ON_DESELECT);
                    }
    ...
    public void processToolkit(short event) {
        ...
        case 1:
            ...
            try {
                bRes = (AdminFileViewBuilder.getTheAdminFileView(unknownAid, JCSystem.NOT_A_TRANSIENT_OBJECT) == null);
            }
            catch(Exception e) {
                bRes = false;
            }
        ...
        case 2:
            ...
            try {
                adminFileView_1 = AdminFileViewBuilder.getTheAdminFileView(adf1Aid, JCSystem.NOT_A_TRANSIENT_OBJECT);
        ...
        case 3:
            ...
            try {
                adminFileView_2 = AdminFileViewBuilder.getTheAdminFileView(adf1Aid, JCSystem.CLEAR_ON_RESET);
        ...
        case 4:
            ...
            try {
                adminFileView_2.select(UICCTestConstants.FID_DF_TEST);
                adminFileView_2.select(UICCTestConstants.FID_EF_RFU1);
            }
            catch (UICCException e) {
                bRes &= (e.getReason() == UICCException.FILE_NOT_FOUND);
            }
        ...
        case 6:
            ...
            try {
                ...
                adminFileView_1.select(UICCTestConstants.FID_ADF);
                adminFileView_1.select(UICCTestConstants.FID_DF_TEST);
                adminFileView_1.select(UICCTestConstants.FID_EF_LARU);
                
                adminFileView_2.select(UICCTestConstants.FID_ADF);
                adminFileView_2.select(UICCTestConstants.FID_DF_TEST);
                adminFileView_2.select(UICCTestConstants.FID_EF_CARU);
                
                try 
                {
                    adminFileView_3.select(UICCTestConstants.FID_ADF);
                    adminFileView_3.select(UICCTestConstants.FID_DF_TEST);
        ...
        case 8:
            ...
            if (transientAvailable < (short)0x7FFF)
            {
                ...
                try {
                    AdminFileViewBuilder.getTheAdminFileView(adf1Aid, JCSystem.CLEAR_ON_RESET);
                }
                catch (SystemException e) {
                    bRes = (e.getReason() == SystemException.NO_TRANSIENT_SPACE);
                }
        ...
        case 9:
            ...
            for (event_code=-128; event_code <= 127; event_code++) {
                ...
                try {
                    AdminFileViewBuilder.getTheAdminFileView(adf1Aid, (byte) event_code);
                }
                catch (SystemException e) {
        ...
        case 10:
            ...
            try {
                AdminFileViewBuilder.getTheAdminFileView(null, JCSystem.NOT_A_TRANSIENT_OBJECT);
            }
    ...
    private boolean checkFCP_adf1() {
        ...
        editHandler.appendArray(fcp, (short) offsetFcpTLVList, (short) (fcpLen-offsetFcpTLVList));
        return (editHandler.findAndCompareValue((byte) 0x84, abAdf1Aid, (short) 0) == 0);
    }
