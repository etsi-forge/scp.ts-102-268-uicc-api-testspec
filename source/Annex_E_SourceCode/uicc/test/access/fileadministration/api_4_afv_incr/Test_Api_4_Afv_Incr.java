...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.access.fileadministration.api_4_afv_incr;
...
public class Test_Api_4_Afv_Incr extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/access/fileadministration/api_4_afv_incr";
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("10" + APPLET_AID_1 + "0F" +
