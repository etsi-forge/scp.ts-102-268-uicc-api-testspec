...
public class Test_Api_4_Aex_Thit extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/access/fileadministration/api_4_aex_thit";
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("10" + APPLET_AID_1 + "06" + "CCCCCCCC CCCC"));
