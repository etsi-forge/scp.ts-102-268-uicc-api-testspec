...
package uicc.test.access.api_1_usy_getfob;
...
public class Api_1_Usy_Getfob_1 extends TestToolkitApplet implements UICCConstants {
    ...
    private static AID     adf1Aid          = null;
    ...
    public Api_1_Usy_Getfob_1() {
        ...
        adf1Aid = new AID(abAdf1Aid, (short) 0, (byte) abAdf1Aid.length);
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        ...
        Api_1_Usy_Getfob_1 thisApplet = new Api_1_Usy_Getfob_1();
        ...
        try {
            bRes1 = (UICCSystem.getTheFileView(adf1Aid, JCSystem.CLEAR_ON_RESET) == null);
        }
        catch(Exception e) {
            bRes1 = false;
        }
    ...
    public void process(APDU apdu) {
        if (selectingApplet()) {
            ...
            case 1:
                ...
                try {
                    fileView_3 = UICCSystem.getTheFileView(adf1Aid, JCSystem.CLEAR_ON_DESELECT);
            ...
            case 3:
                ...
                try {
                    UICCSystem.getTheFileView(adf1Aid, JCSystem.CLEAR_ON_DESELECT);
                }
    ...
    public void processToolkit(short event) {
        ...
        case 1:
            ...
            try {
                bRes = (UICCSystem.getTheFileView(unknownAid, JCSystem.NOT_A_TRANSIENT_OBJECT) == null);
            }
            catch(Exception e) {
                bRes = false;
            }
        ...
        case 2:
            ...
            try {
                fileView_1 = UICCSystem.getTheFileView(adf1Aid, JCSystem.NOT_A_TRANSIENT_OBJECT);
        ...
        case 3:
            ...
            try {
                fileView_2 = UICCSystem.getTheFileView(adf1Aid, JCSystem.CLEAR_ON_RESET);
        ...
        case 8:
            ...
            try {
                UICCSystem.getTheFileView(adf1Aid, JCSystem.CLEAR_ON_RESET);
            }
            catch (SystemException e) {
                bRes = (e.getReason() == SystemException.NO_TRANSIENT_SPACE);
            }
        ...
        case 9:
            ...
            for (event_code=(short)3; event_code <=(short)0xFF; event_code++) {
                try {
                    UICCSystem.getTheFileView(adf1Aid, (byte) event_code);
                }
                catch (SystemException e) {
        ...
        case 10:
            ...
            try {
                UICCSystem.getTheFileView(null, JCSystem.NOT_A_TRANSIENT_OBJECT);
            }
