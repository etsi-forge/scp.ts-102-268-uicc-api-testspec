 ...
 * Test source for getTheFileView tests
 */
//-----------------------------------------------------------------------------
//    Package Definition
//-----------------------------------------------------------------------------
...
public class Test_Api_1_Usy_Getf_Bsbb extends UiccTestModel {
    static final String CAP_FILE_PATH = "uicc/test/access/api_1_usy_getf_bsbb";
    ...
    public Test_Api_1_Usy_Getf_Bsbb() {
    ...
    public boolean run() {
        ...
        // check results
        response = test.selectApplication(APPLET_AID_1);
        test.addResult(response.checkData("10" + APPLET_AID_1 + "0ACCCCCC CCCCCCCC CCCCCC"));
