...
public class Api_1_Fvw_Slctb_Bss_1 extends TestToolkitApplet{
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        ...
        Api_1_Fvw_Slctb_Bss_1 thisApplet = new Api_1_Fvw_Slctb_Bss_1();
