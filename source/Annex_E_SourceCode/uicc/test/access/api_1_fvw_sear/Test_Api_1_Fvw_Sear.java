...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.access.api_1_fvw_sear;
...
public class Test_Api_1_Fvw_Sear extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/access/api_1_fvw_sear";
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("10" + APPLET_AID_1 + "25" +
