...
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_pah_aptlbbb;
//-----------------------------------------------------------------------------
//Imports
//-----------------------------------------------------------------------------
...
/**
 * Test Area : uicc.test.toolkit.api_2_pah_aptlbbb
 *
 * @version 0.0.1 - 3 mars 2006
 * @author 3GPP T3 SWG API
 */
public class Api_2_Pah_Aptlbbb_1 extends TestToolkitApplet
{
    
    /**
     * Constructor of the applet
     */
    public Api_2_Pah_Aptlbbb_1() 
    {
    }
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Pah_Aptlbbb_1  thisApplet = new Api_2_Pah_Aptlbbb_1();
    ...
    public void processToolkit(short event)
    {
        ...
        byte[] compareBuffer = new byte[256] ;
        ...
        try {
            ...
            compareBuffer[2] = (byte)0xF6 ;
            tag = (byte)0x84 ;
            value1 = (byte)0x00 ;
            value2 = (byte)0x01 ;
            compareBuffer[249] = tag ;
            compareBuffer[250] = (byte)2 ;
            compareBuffer[251] = value1 ;
            compareBuffer[252] = value2 ;
