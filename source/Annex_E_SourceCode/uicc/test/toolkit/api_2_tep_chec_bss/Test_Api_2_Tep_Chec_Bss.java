...
public class Test_Api_2_Tep_Chec_Bss extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/toolkit/api_2_tep_chec_bss";
    ...
    public Test_Api_2_Tep_Chec_Bss() {
