 ...
 */
public class Test_Api_2_Pah_Ingk extends UiccTestModel
{

    static final String CAP_FILE_PATH = "uicc/test/toolkit/api_2_pah_ingk";
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("D0118103 01220082 0281828D 06045465"
                                   + "787441"));
        ...
        /*********************************************************************/
        response = test.fetch("13");
        test.addResult(response.checkData("D0118103 01228182 0281828D 06045465"
                                   + "787445"));
        ...
        /*********************************************************************/
        response = test.fetch("13");
        test.addResult(response.checkData("D0118103 01220082 0281828D 06005465"
                                   + "787446"));
        response = test.terminalResponse("81030122 00020282 81030100");
        test.addResult(response.checkSw("9113"));
        ...
        /*********************************************************************/
        response = test.fetch("13");
        test.addResult(response.checkData("D0118103 01220082 0281828D 06085465"
                                   + "787447"));
        response = test.terminalResponse("81030122 00020282 81030100");
        ...
        test.addResult(response.checkData("D0168103 01220082 0281828D 0B045465"
                                   + "78744854 65787448"));
        response = test.terminalResponse("81030122 00020282 81030100");
        ...
        test.addResult(response.checkData("D00B8103 01220082 0281828D 00"));
        ...
        test.addResult(response.checkData("D0818A81 03012200 82028182 8D7F0455"
        ...
        test.addResult(response.checkData("D0818C81 03012200 82028182 8D818004"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
        ...
        test.addResult(response.checkData("D081FD81 03012200 82028182 8D81F104"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
