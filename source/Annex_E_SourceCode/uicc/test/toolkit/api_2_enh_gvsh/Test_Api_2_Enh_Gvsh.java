 ...
 */
public class Test_Api_2_Enh_Gvsh extends UiccTestModel
{

    static final String CAP_FILE_PATH = "uicc/test/toolkit/api_2_enh_gvsh";
    ...
    public boolean run() {
        ...
        {         
                 /* 1: Send Unrecognized Envelope with Tag 02, length 02
                                                       ...
                                                       Tag 33, length C8.
                 */
                 response = test.sendApdu( "80 C2 00 00 DF"
                                         + "01 81 DC"
                                         + "02 02 83 81"
                                         + "06 06"
                                         + "81112233 44F5"
