...
public class Test_Api_2_Bte_Gvby extends UiccTestModel {
    /** relative path of the package */
    private static String			CAP_FILE_PATH		= "uicc/test/toolkit/api_2_bte_gvby";
    ...
    public boolean run(){
     ...
     // unrecognizeEnvelope to trigger test case 1 to 12 of applet 1
