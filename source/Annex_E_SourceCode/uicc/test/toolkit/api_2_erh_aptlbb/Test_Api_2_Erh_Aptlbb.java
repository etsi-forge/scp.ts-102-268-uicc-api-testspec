//-----------------------------------------------------------------------------
//Test_Api_2_Erh_Aptlbb.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_erh_aptlbb;
...
/**
 * Test Area : uicc.test.toolkit.api_2_erh_aptlbb
 *
 * @version 0.0.1 - 11 avr. 2005
 * @author 3GPP T3 SWG API
 */
public class Test_Api_2_Erh_Aptlbb extends UiccTestModel
{

    static final String CAP_FILE_PATH = "uicc/test/toolkit/api_2_erh_aptlbb";
