...
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_erh_glen;
...
/**
 * Test Area : uicc.test.toolkit.api_2_erh_glen
 *
 * @version 0.0.1 - 5 avr. 2005
 * @author 3GPP T3 SWG API
 */
public class Api_2_Erh_Glen_1 extends TestToolkitApplet {
    ...
    */
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Erh_Glen_1  thisApplet = new Api_2_Erh_Glen_1();
    ...
    public void processToolkit(short event) {
        ...
        case (byte) 0 :
            ...
            try {
                bRes = (EnvRespHdlr.getLength() == (short)0) ;
            }
            catch (Exception e) {
                bRes = false ;
            }
        ...
        case (byte) 1 :
                ...
                // --------------------------------------------
            // Test Case 2 : length = 7
            testCaseNb = (byte) 2 ;
            bRes = false ;

            try {
                EnvRespHdlr.appendTLV((byte)0x01,data,(short) 0x00, (short) 0x07);
                bRes = (EnvRespHdlr.getLength() == (short)9) ;
            }
            catch (Exception e) {
                bRes = false ;
            }
        ...
        case (byte) 3 :
            // --------------------------------------------
            // Test Case 4 : length = 7Fh
            testCaseNb = (byte) 4 ;
            bRes = false ;

            try {
                EnvRespHdlr.appendTLV((byte)0x01,data,(short) 0x00, (short) 0x7F);
                bRes = (EnvRespHdlr.getLength() == (short)0x0081) ;
            }
            catch (Exception e) {
                bRes = false ;
            }
        ...
        case (byte) 4 :
            // --------------------------------------------
            // Test Case 5 : length = 80h
            testCaseNb = (byte) 5 ;
            bRes = false ;

            try {
                EnvRespHdlr.appendTLV((byte)0x01,data,(short) 0x00, (short) 0x80);
                bRes = (EnvRespHdlr.getLength() == (short)0x0083) ;
            }
            catch (Exception e) {
                bRes = false ;
            }
        ...
        case (byte)5:
            // --------------------------------------------
            // Test Case 6 : ToolkitException HANDLER_NO_AVAILABLE
            testCaseNb=(byte)6;
            bRes=false;
