...
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_erh_facybbs_bss;
...
/**
 * Test Area : uicc.test.toolkit.api_2_erh_facybbs_bss
 *
 * @version 0.0.1 - 6 avr. 2005
 * @author 3GPP T3 SWG API
 */
public class Api_2_Erh_Facybbs_Bss_1 extends TestToolkitApplet {
    ...
    */
    public Api_2_Erh_Facybbs_Bss_1() 
    {
    }
    ...
    */
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Erh_Facybbs_Bss_1  thisApplet = new Api_2_Erh_Facybbs_Bss_1();
    ...
    public void processToolkit(short event) {
        ...
        try {
            ...
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (byte)0, null, (byte)0, (byte)1) ;
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (byte)0, dstBuffer, (byte)5, (byte)1) ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (byte)0, dstBuffer, (byte)-1, (byte)1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)0, dstBuffer, (short)0, (short)6) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)0, dstBuffer, (short)3, (short)3) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)0, dstBuffer, (short)0, (short)-1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            ...
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)6, dstBuffer, (short)0, (short)1) ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)-1, dstBuffer, (short)0, (short)1) ;
            }
            catch (ToolkitException e) {
                bRes = (e.getReason()==ToolkitException.OUT_OF_TLV_BOUNDARIES) ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)0, dstBuffer, (short)0, (short)7) ;
            }
            catch (ToolkitException e) {
                bRes = (e.getReason()==ToolkitException.OUT_OF_TLV_BOUNDARIES) ;
            }
        ...
        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)2, dstBuffer, (short)0, (short)5) ;
            }
            catch (ToolkitException e) {
                bRes = (e.getReason()==ToolkitException.OUT_OF_TLV_BOUNDARIES) ;
            }
        ...
        try {
            EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)2, (short)0, dstBuffer, (short)0, (short)1) ;
        }
        catch (ToolkitException e) {
        ...
        try {
            ...
            if(EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)0, dstBuffer, (short)0, (short)17)==(short)17)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            if(EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)1, (short)2, dstBuffer, (short)3, (short)12)==15)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            for (short i=3; i<15; i++) 
                TLVBuffer[i] = (byte)(i-2) ;

            if(Util.arrayCompare(TLVBuffer, (short)0, dstBuffer, (short)0, (short)20)==0)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            if(EnvRespHdlr.findAndCopyValue((byte)0x0D, (byte)2, (short)0, dstBuffer, (short)0, (short)6)==(short)6)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            if(Util.arrayCompare(TLVBuffer, (short)0, dstBuffer, (short)0, (short)6)==0)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            if(EnvRespHdlr.findAndCopyValue((byte)0x8D, (byte)1, (short)0, dstBuffer, (short)0, (short)17)==(short)17)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            // Search tag 8Fh
            if(EnvRespHdlr.findAndCopyValue((byte)0x8F, (byte)1, (short)0, dstBuffer, (short)0, (short)0x80)==(short)0x80)
                bRes = true ;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        Util.arrayFillNonAtomic(TLVBuffer,(short)0,(short)TLVBuffer.length,(byte)0x55);
        Util.arrayCopyNonAtomic(ref_data,(short)0,TLVBuffer,(short)0,(short)0x80);
        ...
        // --------------------------------------------
        // Test Case 24 : Successful call (with the length = 0 and the offset = length of the comparaison buffer)
        testCaseNb = (byte) 24 ;
        bRes = false ;

        try {
            // Search tag 8Fh
            if(EnvRespHdlr.findAndCopyValue((byte)0x8F, (byte)0x01, (short)0, dstBuffer, (short)dstBuffer.length, (short)0)==(short)dstBuffer.length)
                bRes = true ;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 25 : BAD INPUT PARAMETER, occurence = 0
        testCaseNb = (byte) 25 ;
        bRes = false ;

        try {
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x8F, (byte)0, (short)0, dstBuffer, (short)0, (short)0);
            }
            catch (ToolkitException e) {
        ...
        // --------------------------------------------
        // Test Case 26 : ToolkitException HANDLER_NOT_AVAILABLE
        testCaseNb = (byte) 26 ;
        bRes = false ;
        ...
        try {
            ...
            try {
                EnvRespHdlr.findAndCopyValue((byte)0x8F, (byte)1, (short)0, dstBuffer, (short)0, (short)0);
            }
            catch (ToolkitException e) {
