//-----------------------------------------------------------------------------
//Api_2_Erh_Copy_1.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_erh_copy;
...
/**
 * Test Area : uicc.test.toolkit.api_2_erh_copy
 *
 * @version 0.0.1 - 5 avr. 2005
 * @author 3GPP T3 SWG API
 */
public class Api_2_Erh_Copy_1 extends TestToolkitApplet {
    ...
    */
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Erh_Copy_1  thisApplet = new Api_2_Erh_Copy_1();
    ...
    public void processToolkit(short event){
        ...
        case (byte) 0 :
            // --------------------------------------------
            // Test Case 1 : try to use copy value method with the destination buffer null
            testCaseNb = (byte) 1 ;
            bRes = false ;

            // Null as dstBuffer
            try {
                // Build a 7Fh byte command
                EnvRespHdlr.appendTLV((byte)0x33,data,(short) 0x00, (short) 0x07);
                EnvRespHdlr.copy(null, (short)0, (short)1) ;
            }
            ...
            try {
                ...
                EnvRespHdlr.copy(dstBuffer, (short)5, (short)1) ;
            }
            ...
            try {
                byte[] dstBuffer = new byte[5] ;
                EnvRespHdlr.copy(dstBuffer, (short)-1, (short)1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
            ...
            try {
                byte[] dstBuffer = new byte[5] ;
                EnvRespHdlr.copy(dstBuffer, (short)0, (short)6) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
            ...
            try {
                byte[] dstBuffer = new byte[5] ;
                EnvRespHdlr.copy(dstBuffer, (short)3, (short)3) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                    bRes = true ;
            }
            ...
            try {
                ...
                EnvRespHdlr.copy(dstBuffer, (short)0, (short)-1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
            ...
            try {
                byte[] dstBuffer = new byte[10] ;
                EnvRespHdlr.copy(dstBuffer, (short)0, (short)10) ;
            }
            ...
            try {
                ...
                if(EnvRespHdlr.copy(dstBuffer, (short)0, (short)9)==9)
                    bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
            ...
            byte[] compareBuffer = new byte[9] ;

            try {
                // Initialise buffers
                Util.arrayCopyNonAtomic(data,(short)0,compareBuffer,(short)2,(short)7);
                compareBuffer[0]=0x33;
                compareBuffer[1]=0x07;

                // Compare buffers
                byte[] dstBuffer = new byte[9] ;

                if( (EnvRespHdlr.copy(dstBuffer, (short)0, (short)9)==9)
                 && (Util.arrayCompare(compareBuffer, (short)0,dstBuffer, (short)0, (short)9)==0))
                        bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
            ...
            // Compare buffers
            byte[] dstBuffer = new byte[143] ;

            EnvRespHdlr.appendTLV((byte)0x34,data,(short) 0x00, (short)0x0080);
            try {
                if(EnvRespHdlr.copy(dstBuffer, (short)3, (short)0x8C)==(short)0x8F)
                    bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
            ...
            compareBuffer = new byte[143] ;
            Util.arrayFillNonAtomic(compareBuffer,(short)0,(short)compareBuffer.length,(byte)0);
            compareBuffer[3]=0x33;
            compareBuffer[4]=0x07;
            Util.arrayCopyNonAtomic(data,(short)0,compareBuffer,(short)5,(short)7);

            compareBuffer[12]=0x34;
            compareBuffer[13]=(byte)0x81;
            compareBuffer[14]=(byte)0x80;
            Util.arrayCopyNonAtomic(data,(short)0,compareBuffer,(short)15,(short)0x80);

            try {
                if( (EnvRespHdlr.copy(dstBuffer, (short)3, (short)0x8C)==(short)0x8F)
                 && (Util.arrayCompare(compareBuffer, (short)0,dstBuffer, (short)0, (short)compareBuffer.length)==0))
                    bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
    ...
    case (byte) 11 :
            ...
            EnvRespHdlr.appendTLV((byte)0x33,data,(short) 0x00, (short) 13);

            try {
                if(EnvRespHdlr.copy(dstBuffer, (short)3, (short)6)==9)
                    bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
            ...
            compareBuffer[3]=0x33;
            compareBuffer[4]=0x0D;
            Util.arrayCopy(data, (short)0,compareBuffer, (short)5, (short)4);

            try {
                if((EnvRespHdlr.copy(dstBuffer, (short)3, (short)6)==9)&&
                (Util.arrayCompare(compareBuffer, (short)0,dstBuffer, (short)0, (short)15)==0))
                    bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
            ...
            // --------------------------------------------
            // Test Case 14 : successful call with the length=0 and the offset = length of the destination buffer
            testCaseNb = (byte) 14 ;
            bRes = false ;

            try {
                if(EnvRespHdlr.copy(dstBuffer, (short)dstBuffer.length, (short)0)==15)
                    bRes=true;
            }
            catch (Exception e) {
                bRes = false ;
    ...
    case (byte) 14 :
            // --------------------------------------------
            // Test Case 15 : ToolkitException HANDLER_NOT_AVAILABLE
            testCaseNb = (byte) 15 ;
            bRes = false ;
            ...
            try {
                ...
                try {
                    EnvRespHdlr.copy(dstBuffer, (short)0, (short)0);
                    bRes=false;
                }
                catch (ToolkitException e) {
