 ...
 */
public class Api_2_Pah_Indt_1 extends TestToolkitApplet
{
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Pah_Indt_1  thisApplet = new Api_2_Pah_Indt_1();
    ...
    public void processToolkit(short event) 
    {
        ...
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, null, (short)0, (short)1) ;
            }
        ...
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXT, (short)5, (short)0) ;
            }
        ...
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXT, (short)-1, (short)1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXT, (short)0, (short)5) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXT, (short)3, (short)2) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXT, (short)3, (short)-1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTA, (short)0, (short)5) ;
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTB, (short)2, (short)5) ;
            proHdlr.send() ;
            bRes = true ;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTC, (short)0, (short)5) ;
            proHdlr.send() ;
            bRes = true;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTD, (short)2, (short)5) ;
            proHdlr.send() ;
            bRes = true ;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x81, DCS_8_BIT_DATA, TEXTE, (short)0, (short)5) ;
            proHdlr.send() ;
            bRes = true ;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_DEFAULT_ALPHABET , TEXTF, (short)0, (short)5) ;
            proHdlr.send() ;
            bRes = true ;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_UCS2 , TEXTG, (short)0, (short)5) ;
            proHdlr.send() ;
            bRes = true;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTA, (short)0, (short)5) ;
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTH, (short)0, (short)10) ;
            proHdlr.send() ;
            bRes = true ;
        }
        catch (Exception e)    {    
        ...
        try {
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, TEXTH, (short)0, (short)0) ;
            proHdlr.send() ;
            bRes = true ;
        }
        catch (Exception e)    {    
        ...
        // --------------------------------------------
        // Test Case 18 : initDisplayText with buffer length = 7Eh
        testCaseNb = (byte) 18 ;
        bRes = false ;
        
        try {
            // Initialize the command
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, LONGTEXT, (short)0, (short)0x7E) ;
        ...
        // --------------------------------------------
        // Test Case 19 : initDisplayText with buffer length = 7Fh
        testCaseNb = (byte) 19 ;
        bRes = false ;
        
        try {
            // Initialize the command
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, LONGTEXT, (short)0, (short)0x7F) ;
        ...
        // --------------------------------------------
        // Test Case 20 : initDisplayText with buffer length = 240
        testCaseNb = (byte) 20 ;
        bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 21 : initDisplayText with a too long buffer
        testCaseNb = (byte) 21 ;
        bRes = false ;
        
        try {
            try {
                proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, LONGTEXT, (short)0, MAXIMUM_SIZE) ;
            } catch (ToolkitException e) {
        ...
        // --------------------------------------------
        // Test Case 22 : initDisplayText without sending the command
        testCaseNb = (byte) 22 ;
        bRes = false ;
        
        try {
            // Initialize the command
            proHdlr.initDisplayText((byte)0x00, DCS_8_BIT_DATA, LONGTEXT, (short)0, (short)10) ;
