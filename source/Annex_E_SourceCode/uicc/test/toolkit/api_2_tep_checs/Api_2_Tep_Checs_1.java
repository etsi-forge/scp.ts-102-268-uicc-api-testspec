...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_tep_checs;
...
/**
 * uicc.toolkit package, TerminalProfile class, check(short) method
 * applet 1
 */
public class Api_2_Tep_Checs_1 extends TestToolkitApplet {
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) {
        ...
        Api_2_Tep_Checs_1 thisApplet = new Api_2_Tep_Checs_1();
    ...
    public void processToolkit(short event) {
        ...
        if (event == EVENT_UNRECOGNIZED_ENVELOPE)  {
            ...
            bRes = false;
            try {
                bRes = TerminalProfile.check((short)0);
            }
            catch (Exception e) {
                bRes = false;
            }
            ...
            try {
                if (TerminalProfile.check((short)15) == false) {
                    bRes = true;
                } else {
                    bRes = false;
                }
            ...
            try {
                if (TerminalProfile.check((short)0x0099) == false) {
                    bRes = true;
                } else {
                    bRes = false;
                }
            ...
            bRes = false;
            try {
                TerminalProfile.check((short)0x8000);
            }
            catch (ToolkitException e) {
