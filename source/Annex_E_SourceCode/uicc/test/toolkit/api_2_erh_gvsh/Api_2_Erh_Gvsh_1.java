//-----------------------------------------------------------------------------
//Api_2_Erh_Gvsh_1.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_erh_gvsh;
...
/**
 * Test Area : uicc.test.toolkit.api_2_erh_gvsh
 *
 * @version 0.0.1 - 11 avr. 2005
 * @author 3GPP T3 SWG API
 */
public class Api_2_Erh_Gvsh_1 extends TestToolkitApplet {
    ...
    */
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Erh_Gvsh_1  thisApplet = new Api_2_Erh_Gvsh_1();
    ...
    public void processToolkit(short event){
        ...
        try {
            ...
            if((EnvRespHdlr.findTLV((byte)0x03, (byte)1)==TLV_NOT_FOUND)&&
                (EnvRespHdlr.getValueShort((short)0)==0))
                    bRes=false;
        }
        ...
        try {
            ...
            if((EnvRespHdlr.findTLV((byte)0x01, (byte)1)==TLV_FOUND_CR_SET)
             &&(EnvRespHdlr.getValueShort((short)3)==0))
                    bRes=false;
        }
        catch (ToolkitException e) {
        ...
        try {
            // Find String TLV
            if((EnvRespHdlr.findTLV((byte)0x01, (byte)1)==TLV_FOUND_CR_SET)
             &&(EnvRespHdlr.getValueShort((short)1)==(short)0x22FE))
                    bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            if((EnvRespHdlr.findTLV((byte)0x02, (byte)1)==TLV_FOUND_CR_SET)
             &&(EnvRespHdlr.getValueShort((short)0)==(short)0x8182))
                    bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            if((EnvRespHdlr.findTLV((byte)0x0D, (byte)1)==TLV_FOUND_CR_NOT_SET)
             &&(EnvRespHdlr.getValueShort((short)0x7C)==(short)0x7C7D))
                    bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            //built the first TLV
            EnvRespHdlr.clear();
            EnvRespHdlr.appendTLV((byte)0x0D,data,(short) 0x00, (short) 0x81);

            // get the value byte
            if((EnvRespHdlr.findTLV((byte)0x0D, (byte)1)==TLV_FOUND_CR_NOT_SET)
             &&(EnvRespHdlr.getValueShort((short)0x7D)==(short)0X7D7E))
                    bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            // get the value byte
            if((EnvRespHdlr.findTLV((byte)0x0D, (byte)1)==TLV_FOUND_CR_NOT_SET)
             &&(EnvRespHdlr.getValueShort((short)0x7F)==(short)0x7F80))
                    bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            // get the value byte
            if((EnvRespHdlr.findTLV((byte)0x0D, (byte)1)==TLV_FOUND_CR_NOT_SET)
             &&(EnvRespHdlr.getValueShort((short)0xEF)==(short)0xEFF0))
                    bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            ...
            try {
                EnvRespHdlr.getValueShort((short)0);
                bRes= false;
            }
            catch (ToolkitException e) {
