...
public class Test_Api_2_Bte_Facrbbs_Bss extends UiccTestModel {
	/** relative path of the package */
	private static String			CAP_FILE_PATH		= "uicc/test/toolkit/api_2_bte_facrbbs_bss";
	 ...
	 *
	 */
	public Test_Api_2_Bte_Facrbbs_Bss(){
