...
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_erh_facrb_bs;
...
/**
 * Test Area : uicc.test.toolkit.api_2_erh_facrb_bs
 *
 * @version 0.0.1 - 7 avr. 2005
 * @author 3GPP T3 SWG API
 */
public class Api_2_Erh_Facrb_Bs_1 extends TestToolkitApplet {
    ...
    */
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Erh_Facrb_Bs_1  thisApplet = new Api_2_Erh_Facrb_Bs_1();
    ...
    public void processToolkit(short event) {
        ...
        try {
            ...
            try {
                EnvRespHdlr.findAndCompareValue((byte)0x0D, null, (short)0) ;
            }
        ...
        try {
            ...
            try {
                EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short) 20) ;
        ...
        try {
            try {
                EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)-1) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        // --------------------------------------------
        // Test Case 4 : compareOffset + length > compareBuffer.length
        testCaseNb = (byte) 4 ; 
        bRes = false ;

        try {
            try {
                EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)5) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        // --------------------------------------------
        // Test Case 5 : length > compareBufferLength
        testCaseNb = (byte) 5 ;
        bRes = false ;
        ...
        try {
            try {
                ...
                EnvRespHdlr.findAndCompareValue((byte)0x0D, compareBuffer, (short)0) ;
            }
            catch (ArrayIndexOutOfBoundsException e) {
                bRes = true ;
            }
        ...
        // Search a wrong TLV
        try {
            EnvRespHdlr.findAndCompareValue((byte)0x03, TLVBuffer, (short)0) ;
        ...
        // --------------------------------------------
        // Test Case 7 : verify the current TLV
        testCaseNb = (byte) 7 ;
        bRes = false ;
        ...
        try {
            ...
            if(EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)0)==0)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 9 : Verify current TLV
        testCaseNb = (byte) 9 ;
        bRes = false ;
        ...
        TLVBuffer[16] = (byte)0x10;

        try {
            if(EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)0)==-1)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // Initialise compare buffer
        TLVBuffer[16] = (byte)0x0F;
        TLVBuffer[0] = (byte)0x03;
        ...
        try {
            if(EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)2)==0)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        EnvRespHdlr.clear();
        // Append the first Text String TLV
        EnvRespHdlr.appendTLV((byte)0x0D,ref_data,(short) 0x00, (short)0x81);
        ...
        try {
            ...
            if(EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)3)==0)
                bRes = true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        try {
            if(EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)3)==(short)-1)
                bRes = true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 15 : Successful call with 2 Text String TLV
        testCaseNb = (byte) 15 ;
        bRes = false ;
        ...
        try {
            if(EnvRespHdlr.findAndCompareValue((byte)0x0D, TLVBuffer, (short)3)==1)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 16 : Successful call : search tag 8Dh
        testCaseNb = (byte) 16 ;
        bRes = false ;
        ...
        try {
            ...
            // Search tag 8Dh
            if(EnvRespHdlr.findAndCompareValue((byte)0x8D, TLVBuffer, (short)0)==0)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 17 : Successful call : search tag 8Fh
        testCaseNb = (byte) 17 ;
        bRes = false ;
        ...
        try {
            ...
            //initilase the compare buffer
            for(short i=1;i<17;i++)
                TLVBuffer[(short)(i-1)]=TLVBuffer[i];

            // Search tag 8Fh
            if(EnvRespHdlr.findAndCompareValue((byte)0x8F, TLVBuffer, (short)0)==0)
                bRes=true;
        }
        catch (Exception e) {
            bRes = false ;
        ...
        // --------------------------------------------
        // Test Case 18 : ToolkitException HANDLER_NOT_AVAILABLE
        testCaseNb = (byte) 18 ;
        bRes = false ;
        ...
        try {
            ...
            try {
                EnvRespHdlr.findAndCompareValue((byte)0, dstBuffer, (short)0);
            }
            catch (ToolkitException e) {
