...
public class Test_Api_2_Bte_Copy extends UiccTestModel {
    /** relative path of the package */
    private static String			CAP_FILE_PATH		= "uicc/test/toolkit/api_2_bte_copy";
    ...
    public boolean run(){
        ...
        test.terminalProfileSession(TERMINAL_PROFILE);
         // unrecognizeEnvelope trigger test case 1 to 13 of applet 1
