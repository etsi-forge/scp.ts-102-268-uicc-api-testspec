...
public class Test_Api_2_Pah_Ingp extends UiccTestModel
{
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("D0158103 01230082 0281828D 06045465"
                                  +  "78744191 0200FF"));
        ...
        /*********************************************************************/
        response = test.fetch("17");
        test.addResult(response.checkData("D0158103 01238182 0281828D 06045465"
                                   + "78744591 020010"));
        ...
        /*********************************************************************/
        response = test.fetch("17");
        test.addResult(response.checkData("D0158103 01230082 0281828D 06005465"
                                   + "78744691 021010"));
        response = test.terminalResponse("81030123 00020282 81030100 0D020441");
        test.addResult(response.checkSw("9117"));
        ...
        /*********************************************************************/
        response = test.fetch("17");
        test.addResult(response.checkData("D0158103 01230082 0281828D 06085465"
                                   + "78744791 0200FF"));
        response = test.terminalResponse("81030123 00020282 81030100 0D020441");
        ...
        test.addResult(response.checkData("D01A8103 01230082 0281828D 0B045465"
                                   + "78744854 65787448 91020010"));
        response = test.terminalResponse("81030123 00020282 81030100 0D020441");
        test.addResult(response.checkSw("9111"));

        /*********************************************************************/
        /** Testcase 16                                                      */
        /*********************************************************************/
        response = test.fetch("11");
        test.addResult(response.checkData("D00F8103 01230082 0281828D 00910200"
                                   + "10"));
        
        response = test.terminalResponse("81030123 00020282 81030100 0D020441");
        test.addResult(response.checkSw("9191"));
        
        /*********************************************************************/
        /** Testcase 17,18                                                   */
        /*********************************************************************/
        response = test.fetch("91");
        test.addResult(response.checkData("D0818E81 03012300 82028182 8D7F0455"
        ...
        response = test.terminalResponse("81030123 00020282 81030100 0D020441");
        test.addResult(response.checkSw("9193"));

        /*********************************************************************/
        /** Testcase 19                                                      */
        /*********************************************************************/
        response = test.fetch("93");
        test.addResult(response.checkData("D0819081 03012300 82028182 8D818004"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
        ...
        test.addResult(response.checkData("D081FD81 03012300 82028182 8D81ED04"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
                                   + "55555555 55555555 55555555 55555555"
