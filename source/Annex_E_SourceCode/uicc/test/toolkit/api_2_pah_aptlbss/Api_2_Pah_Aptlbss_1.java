//-----------------------------------------------------------------------------
//Api_2_Pah_Aptlbss_1.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_pah_aptlbss;
 ...
 */
public class Api_2_Pah_Aptlbss_1 extends TestToolkitApplet
{
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Pah_Aptlbss_1  thisApplet = new Api_2_Pah_Aptlbss_1();
    ...
    public void processToolkit(short event)
    {
        ...
        try {
            ...
            compareBuffer[2] = (byte)(value1>>8 & (short)0x00FF) ;
            compareBuffer[3] = (byte)(value1 & (short)0x00FF) ;
            compareBuffer[4] = (byte)(value2>>8 & (short)0x00FF) ;
            compareBuffer[5] = (byte)(value2 & (short)0x00FF) ;
        ...
        try {
            ...
            compareBuffer[8] = (byte)(value1>>8 & (short)0x00FF);
            compareBuffer[9] = (byte)(value1 & (short)0x00FF);
            compareBuffer[10] = (byte)(value2>>8 & (short)0x00FF);
            compareBuffer[11] = (byte)(value2 & (short)0x00FF);
        ...
        try {
            ...
            value1 = (short)0x0001;
            value2 = (short)0x0203;
            compareBuffer[247] = tag ;
            compareBuffer[248] = (byte) 4;
            compareBuffer[249] = (byte)(value1>>8 & (short)0x00FF);
            compareBuffer[250] = (byte)(value1 & (short)0x00FF);
