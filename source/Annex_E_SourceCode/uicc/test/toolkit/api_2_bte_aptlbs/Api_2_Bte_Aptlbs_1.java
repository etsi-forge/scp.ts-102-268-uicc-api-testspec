...
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_bte_aptlbs;
//-----------------------------------------------------------------------------
//Imports
//-----------------------------------------------------------------------------
...
public class Api_2_Bte_Aptlbs_1 extends TestToolkitApplet {
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) throws ISOException {
        Api_2_Bte_Aptlbs_1 applet = new Api_2_Bte_Aptlbs_1();
    ...
    public void processToolkit(short event) throws ToolkitException {
        ...
        try {
            ...
            try{
                bte_handler.appendTLV((byte)0x0D,(short)1);
            }
        ...
        try{
            ...
            //-call appendTLV()
            bte_handler.appendTLV((byte)0x0E,(short)0);
            //-verify current TLV
        ...
        try{
            ...
            //- clear the handler
            bte_handler.clear();
            bte_handler.appendTLV((byte)0x84,Util.makeShort((byte)0x00,(byte)0x01));
            buffer= new byte[4];
        ...
        try{
            ...
            //-succesful call
            bte_handler.appendTLV((byte)0x01,Util.makeShort((byte)0xFE,(byte)0xFF));
            buffer= new byte[8];
            compareBuffer=new byte[]{(byte)0x84,(byte)0x02,(byte)0x00,(byte)01,(byte)01,(byte)0x02,(byte)0xFE,(byte)0xFF};
            //-call copy method
