...
/**
 * Test Area : uicc.test.toolkit.Api_2_Enh_Facrbbs_Bss
 *
 * @version 0.0.1 - 3 nov. 2004
 * @author 3GPP T3 SWG API
 */
public class Test_Api_2_Enh_Facrbbs_Bss extends UiccTestModel
{

    static final String CAP_FILE_PATH = "uicc/test/toolkit/api_2_enh_facrbbs_bss";
    ...
    public Test_Api_2_Enh_Facrbbs_Bss() {
