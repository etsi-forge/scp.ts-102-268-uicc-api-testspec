 ...
 */
public class Api_2_Prh_Gvsh_1 extends TestToolkitApplet
{
    // Result of tests
    boolean bRes ;
    ...
    public void processToolkit(short event) 
    {
        ...
        try {
            ...
            try {
                valueOffset = (short)0 ;
                proHdlr.getValueShort(valueOffset) ;
        ...
        try {
            ...
            try {
                valueOffset = (short)3 ;
                result = proRespHdlr.getValueShort(valueOffset) ;
            } catch (ToolkitException e) {
