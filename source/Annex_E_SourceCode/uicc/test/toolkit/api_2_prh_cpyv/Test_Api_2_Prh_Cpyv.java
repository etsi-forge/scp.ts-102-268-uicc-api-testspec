 ...
 */
public class Test_Api_2_Prh_Cpyv extends UiccTestModel
{
    static final String CAP_FILE_PATH = "uicc/test/toolkit/api_2_prh_cpyv";
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("D0148103 01230182 0281828D 05045465"
                                   + "78749102 0005"));
