//-----------------------------------------------------------------------------
//Api_2_Pah_Gvby_1.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_pah_gvby;
...
/**
 * Test Area : uicc.test.toolkit.api_2_pah_gvby
 *
 * @version 0.0.1 - 14 juin 2005
 * @author 3GPP T3 SWG API
 */
public class Api_2_Pah_Gvby_1 extends TestToolkitApplet
{
    private byte TYPE = (byte) 0xFF ;
    private byte QUALIFIER = (byte) 0xFE ;
    private byte DST_DEVICE = (byte) 0xFD ;
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Api_2_Pah_Gvby_1  thisApplet = new Api_2_Pah_Gvby_1();
    ...
    public void processToolkit(short event) 
    {
        ...
        try {
            ...
            try {
                result = proHdlr.getValueByte((short)3) ;
            } catch (ToolkitException e) {
        ...
        try {
            ...
            // Get Qualifier
            result = proHdlr.getValueByte((short)2) ;
            
            bRes = (result == QUALIFIER) ;
        }
        catch (Exception e)    {    
            bRes = false ;
        }
        ...
        try {
            ...
            // Get Source Device
            result = proHdlr.getValueByte((short)0) ;
            
            bRes = (result == (byte)0x81) ;
        }
        catch (Exception e)    {    
            bRes = false ;
        }
        ...
        try {
            ...
            result = proHdlr.getValueByte((short)0x7E) ;
            
            bRes = (result == (byte)0x7D) ;
        }
        catch (Exception e)    {    
            bRes = false ;
        }
        ...
        try {
            ...
            result = proHdlr.getValueByte((short)0x7F) ;
        ...
        try {
            ...
            result = proHdlr.getValueByte((short)0xF0) ;
