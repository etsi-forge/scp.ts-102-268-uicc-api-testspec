...
public class Test_Api_2_Bte_Facyb_Bs extends UiccTestModel {
    /** relative path of the package */
    private static String			CAP_FILE_PATH		= "uicc/test/toolkit/api_2_bte_facyb_bs";
     ...
     *
     */
    public Test_Api_2_Bte_Facyb_Bs(){
