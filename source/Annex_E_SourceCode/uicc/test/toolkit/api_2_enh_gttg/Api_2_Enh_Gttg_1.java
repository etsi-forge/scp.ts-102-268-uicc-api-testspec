//-----------------------------------------------------------------------------
//Api_2_Enh_Gttg_1.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//Package Definition
//-----------------------------------------------------------------------------
package uicc.test.toolkit.api_2_enh_gttg;
...
/**
 * Test Area : uicc.test.toolkit.Api_2_Enh_Gttg
 *
 * @version 0.0.1 - 3 nov. 2004
 * @author 3GPP T3 SWG API
 */
public class Api_2_Enh_Gttg_1 extends TestToolkitApplet
{
    // Result of tests
    boolean bRes ;
    ...
    public void processToolkit(short event) 
    {
        ...
        // Get the system instance of handlers
                ...
                // --------------------------------------------
                // Test Case 1 : GetTag() after applet triggering
                testCaseNb = (byte) 1 ;
                bRes = false ;
                try {
                        if(envHdlr.getTag() == (byte)0x01)
                                bRes = true;
                        else
                                bRes = false;
                }
                ...
                // --------------------------------------------
                // Test Case 2 : GetTag() after proactive command
