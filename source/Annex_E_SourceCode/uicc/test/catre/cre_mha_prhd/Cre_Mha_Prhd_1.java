...
public class Cre_Mha_Prhd_1 extends TestToolkitApplet {
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) throws ISOException {
        ...
        Cre_Mha_Prhd_1 applet = new Cre_Mha_Prhd_1();
    ...
    /**
     * Verify if the proactive response handler is available or not
     */
