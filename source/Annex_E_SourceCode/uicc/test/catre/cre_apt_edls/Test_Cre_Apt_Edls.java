...
public class Test_Cre_Apt_Edls extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edls";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("09010000 11");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_LOCATION_STATUS  ***
        //***TEST CASE 1: 2-APPLET 1 IS TRIGGERED***
        test.envelopeEventDownloadLocationStatus();
        //***TEST CASE 2: 1-APPLET 1 IS NOT TRIGGERED***
        test.envelopeEventDownloadLocationStatus();
        //***TEST CASE 2: 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_LOCATION_STATUS  ***
