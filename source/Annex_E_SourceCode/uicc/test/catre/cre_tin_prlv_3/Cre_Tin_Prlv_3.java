...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.catre.cre_tin_prlv_3;
...
public class Cre_Tin_Prlv_3 extends TestToolkitApplet
{
     ...
     */
    public Cre_Tin_Prlv_3() 
    {
		Cre_Tin_Prlv_3.bNbInstance ++;
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Cre_Tin_Prlv_3 thisApplet = new Cre_Tin_Prlv_3();
    ...
    public void processToolkit(short event) 
    {
		...
		// -----------------------------------------------------------------
		//		 Instance 1 execution, Priority Level 80
		// -----------------------------------------------------------------
		...
		// -----------------------------------------------------------------
		//		 Instance 2 execution, Priority Level 7F
		// -----------------------------------------------------------------
