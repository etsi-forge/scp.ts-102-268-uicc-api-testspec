...
public class Test_Cre_Apt_Edns extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edns";
    ...
    public boolean run() {
        ...
        test.envelopeEventDownloadNetworkSearchModeChange();
