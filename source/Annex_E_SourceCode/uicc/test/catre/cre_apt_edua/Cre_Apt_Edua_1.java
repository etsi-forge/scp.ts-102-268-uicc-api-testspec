...
package uicc.test.catre.cre_apt_edua;
...
/**
 * Test Area: UICC CAT Runtime Environment Applet Triggering EVENT_EVENT_DOWNLOAD_USER_ACTIVITY
 *
 *
 *
 *
...
public class Cre_Apt_Edua_1 extends TestToolkitApplet{
    ...
    public static void install (byte bArray[], short bOffset, byte bLength){
        ...
        Cre_Apt_Edua_1 thisApplet = new Cre_Apt_Edua_1();

        // Register the new applet instance to the JCRE
        thisApplet.register(bArray, (short)(bOffset+1), bArray[bOffset]);
        // Initialise the data of the test applet
        thisApplet.init();
        //register to EVENT DOWNLOAD USER ACTIVITY
        ...
        bRes=thisApplet.obReg.isEventSet(EVENT_EVENT_DOWNLOAD_USER_ACTIVITY);
    }
    ...
    public void processToolkit(short event){
        ...
        if(event==EVENT_EVENT_DOWNLOAD_USER_ACTIVITY){
            ...
            switch(testCaseNb){
                ...
                case (byte)0x00:
                    ...
                    try{
                        //deregister to the event EVENT_EVENT_DOWNLOAD_USER_ACTIVITY
        ...
        //TEST CASE 4: THE APPLET IS REGISTERED TO THE EVENT
            ...
            try{
                //register to the event EVENT_EVENT_DOWNLOAD_USER_ACTIVITY
                obReg.setEvent(EVENT_EVENT_DOWNLOAD_USER_ACTIVITY);
                bRes=true;
            }
            catch(Exception e){
                bRes=false;
