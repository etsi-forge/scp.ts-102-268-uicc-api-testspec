...
public class Test_Cre_Apt_Edua extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edua";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("09010000 21");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_USER_ACTIVITY ***
        //***TEST CASE 1: 2-APPLET 1 IS TRIGGERED***
        test.envelopeEventDownloadUserActivity();
        //***TEST CASE 2: 1-APPLET 1 IS NOT TRIGGERED***
        test.envelopeEventDownloadUserActivity();
        //***TEST CASE 2: 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_USER_ACTIVITY
