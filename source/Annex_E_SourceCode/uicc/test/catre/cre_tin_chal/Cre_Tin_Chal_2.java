...
public class Cre_Tin_Chal_2 extends TestToolkitApplet {

    // Channel number to open
    public final static short CHANNELS_NB = 4;
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) {
        ...
        Cre_Tin_Chal_2 thisApplet = new Cre_Tin_Chal_2();
    ...
    public void processToolkit(short event) {
	    ...
	    if (event == EVENT_MENU_SELECTION) {
            ...
            // --------------------------------------------
            // Test Case 4 : Open one more channel     
            bRes = false ;
            ...
            try {
			    ...
			    bRes = (e.getReason()==ToolkitException.COMMAND_NOT_ALLOWED);
		    }
            reportTestOutcome(testCaseNb, bRes) ;
