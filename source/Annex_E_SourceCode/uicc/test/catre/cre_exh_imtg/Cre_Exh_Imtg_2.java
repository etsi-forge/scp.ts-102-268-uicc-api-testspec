...
public class Cre_Exh_Imtg_2 extends TestToolkitApplet {
    ...
    public static void install(byte[] bArray, short bOffset, byte bLength) {
        Cre_Exh_Imtg_2  thisApplet = new Cre_Exh_Imtg_2();
    ...
    public void processToolkit (short event) throws ToolkitException {
        ...
        if (event == EVENT_UNRECOGNIZED_ENVELOPE) {
            ...
            /*------------------------------------------------------------------
             * TC 03: EVENT_UNRECOGNIZED_ENVELOPE
             *----------------------------------------------------------------*/
        ...
        if (event == EVENT_EVENT_DOWNLOAD_MT_CALL) {
            ...
            /*------------------------------------------------------------------
             * TC 04: EVENT_EVENT_DOWNLOAD_MT_CALL
             *----------------------------------------------------------------*/
