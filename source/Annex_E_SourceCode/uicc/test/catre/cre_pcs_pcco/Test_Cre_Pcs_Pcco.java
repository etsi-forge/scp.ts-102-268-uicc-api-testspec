...
public class Test_Cre_Pcs_Pcco extends UiccTestModel {
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("D0118103 01270082 02818224 01012503" +
                                     "000100"));
        response = test.terminalResponse("81030127 00820282 81030100 24010125" +
                                         "03000100");
        test.addResult(response.checkSw("9113"));
        response = test.fetch("13");
        test.addResult(response.checkData("D0118103 01270082 02818224 01022503" +
                                     "000100"));
        response = test.terminalResponse("81030127 00820282 81030100 24010125" +
                                         "03000100");
        test.addResult(response.checkSw("9113"));
        response = test.fetch("13");
        test.addResult(response.checkData("D0118103 01270082 02818224 01032503" +
                                     "000100"));
        response = test.terminalResponse("81030127 00820282 81030100 24010125" +
                                         "03000100");
        test.addResult(response.checkSw("9000"));
        ...
        response = test.terminalResponse("81030140 01820282 81030100 38028100" +
                                         "35040100 00003902 0080");
        test.addResult(response.checkSw("9117"));
        // Fetch the Open Channel GPRS
        response = test.fetch("17");
        test.addResult(response.checkData("D0158103 01400182 02818235 06020101" +
                                     "02013139 020080"));
        ...
        test.addResult(response.checkData("D00E8103 01470082 02818241 03000000"));
        response = test.terminalResponse("81030147 00820282 81030100");
        test.addResult(response.checkSw("9110"));
        response = test.fetch("10");
        test.addResult(response.checkData("D00E8103 01470082 02818241 03000100"));
        response = test.terminalResponse("81030147 00820282 81030100");
        test.addResult(response.checkSw("9110"));
        response = test.fetch("10");
        test.addResult(response.checkData("D00E8103 01470082 02818241 03000200"));
        response = test.terminalResponse("81030147 00820282 81030100");
        test.addResult(response.checkSw("9110"));
        
        // Fecth 3 Declare Service "Delete" proactive commands
        response = test.fetch("10");
        test.addResult(response.checkData("D00E8103 01470182 02818241 03000000"));
        response = test.terminalResponse("81030147 01820282 81030100");
        test.addResult(response.checkSw("9110"));
        response = test.fetch("10");
        test.addResult(response.checkData("D00E8103 01470182 02818241 03000100"));
        response = test.terminalResponse("81030147 01820282 81030100");
        test.addResult(response.checkSw("9110"));
        response = test.fetch("10");
        test.addResult(response.checkData("D00E8103 01470182 02818241 03000200"));
        response = test.terminalResponse("81030147 01820282 81030100");
        test.addResult(response.checkSw("9000"));
        ...
        test.addResult(response.checkData("D00D8103 01000082 02810000 020000"));
        ...
        test.addResult(response.checkData("10" + APPLET_AID_1 + "12" +
            "CCCCCCCC CCCCCCCC CCCCCCCC CCCCCCCC" +
            "CCCC"));
        response = test.selectApplication(APPLET_AID_2);
        test.addResult(response.checkData("10" + APPLET_AID_2 + "0B" +
