...
public class Test_Cre_Apt_Euev extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_euev";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("FFFFFFFF FFFFFFFF FFFFFFFF");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_UNRECOGNIZED_ENVELOPE    ***
        //***TEST CASE 1: 2-APPLET 1 IS TRIGGERED***
        test.unrecognizedEnvelope();
        //***TEST CASE 2: 1-APPLET 1 IS NOT TRIGGERED***
        test.unrecognizedEnvelope();
        //***TEST CASE 2: 1 APPLET 1 IS REGISTERED TO EVENT_UNRECOGNIZED_ENVELOPE    ***
