...
//  EVENT_DOWNLOAD CARD READER STATUS
//-----------------------------------------------------------------------------
...
public class Test_Cre_Apt_Edcr extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edcr";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("09010000 81");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_CARD_READER_STATUS   ***
