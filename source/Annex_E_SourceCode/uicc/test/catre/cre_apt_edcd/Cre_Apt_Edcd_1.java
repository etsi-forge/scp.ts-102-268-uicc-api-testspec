...
package uicc.test.catre.cre_apt_edcd;
...
/**
 * Test Area: UICC CAT Runtime Environment Applet Triggering EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED
 *
 *
 *
 *
...
public class Cre_Apt_Edcd_1 extends TestToolkitApplet{
    ...
    public static void install (byte bArray[], short bOffset, byte bLength){
        ...
        Cre_Apt_Edcd_1 thisApplet = new Cre_Apt_Edcd_1();

        // Register the new applet instance to the JCRE
        thisApplet.register(bArray, (short)(bOffset+1), bArray[bOffset]);
        // Initialise the data of the test applet
        thisApplet.init();
        //register to EVENT DOWNLOAD CALL DISCONNECTED
        thisApplet.obReg.setEvent(EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED);
        ...
        bRes=thisApplet.obReg.isEventSet(EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED);
    }
    ...
    public void processToolkit(short event){
        ...
        if(event==EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED){
            ...
            //TEST CASE 2: THE APPLET IS UNREGISTERED TO THE EVENT
                    ...
                    try{
                        //deregister to EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED
       ...
       //TEST CASE 4: THE APPLET IS REGISTERED TO THE EVENT
            ...
            try{
                //register to EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED
                obReg.setEvent(EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED);
                bRes=true;
            }
            catch(Exception e){
                bRes=false;
