...
public class Test_Cre_Apt_Edcd extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edcd";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("09010000 09");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_CALL_DISCONNECTED***
