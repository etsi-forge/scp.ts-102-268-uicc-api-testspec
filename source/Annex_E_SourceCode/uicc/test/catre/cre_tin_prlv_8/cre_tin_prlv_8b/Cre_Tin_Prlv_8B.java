//-----------------------------------------------------------------------------
//    Cre_Tin_Prlv_8B.java
//-----------------------------------------------------------------------------

//-----------------------------------------------------------------------------
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.catre.cre_tin_prlv_8.cre_tin_prlv_8b;
...
public class Cre_Tin_Prlv_8B extends TestToolkitApplet
{

    /**
     * Constructor of the applet
     */
    public Cre_Tin_Prlv_8B() 
    {
    }
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Cre_Tin_Prlv_8B thisApplet = new Cre_Tin_Prlv_8B();
    ...
    public void processToolkit(short event) 
    {
		...
		// -----------------------------------------------------------------
			...
			if ( Cre_Tin_Prlv_8.bNbInstanceTriggered == (byte)1 ) {
