...
public class Cre_Mha_Erhd_3 extends TestToolkitApplet {
...
//										  };
	...
	public static void install(byte[] bArray, short bOffset, byte bLength) throws ISOException {
		Cre_Mha_Erhd_3 applet = new Cre_Mha_Erhd_3();
...
//		applet.obReg.setEventList(applet.eventList,(short)0,(short)applet.eventList.length);
	 ...
	 public void process(APDU apdu) {
         if (selectingApplet()){
			 //- TC 1.2 (ld 27)
			 //- The EnvelopeResponseHandler is not available outside the processToolkit() method
			 if (testCaseNb==(byte)0x00){//shall be only selected once
