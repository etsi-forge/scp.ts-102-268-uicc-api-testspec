...
package uicc.test.catre.cre_apt_edbt;
...
public class Cre_Apt_Edbt_1 extends TestToolkitApplet{
    ...
    public static void install (byte bArray[], short bOffset, byte bLength){
        ...
        Cre_Apt_Edbt_1 thisApplet = new Cre_Apt_Edbt_1();

        // Register the new applet instance to the JCRE
        thisApplet.register(bArray, (short)(bOffset+1), bArray[bOffset]);
        // Initialise the data of the test applet
        thisApplet.init();
        //register to EVENT DOWNLOAD BROWSER TERMINATION
        thisApplet.obReg.setEvent(EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION);
        ...
        //register to the EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION
        bRes=thisApplet.obReg.isEventSet(EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION);
    }
    ...
    public void processToolkit(short event){
        ...
        if(event==EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION){
            switch(testCaseNb){
                case (byte)0x00:
                    ...
                    try{
                        //deregister to the event EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION
                        obReg.clearEvent(EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION);
                        bRes=true;
                    }
                    catch(Exception e){
                        bRes=false;
        ...
        //TEST CASE 4: THE APPLET IS REGISTERED TO THE EVENT
            ...
            try{
                //register to the event EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION
                obReg.setEvent(EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION);
                bRes=true;
            }
            catch(Exception e){
                bRes=false;
