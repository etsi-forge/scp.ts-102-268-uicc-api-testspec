//-----------------------------------------------------------------------------
//  Package Definition
//  UICC CAT Runtime Environment Applet Triggering Event
...
public class Test_Cre_Apt_Edbt extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edbt";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("09010000 0002");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION ***
        //***TEST CASE 1: 2-APPLET 1 IS TRIGGERED***
        test.envelopeEventDownloadBrowserTermination();
        test.terminalProfileSession("09010000 0102");
        //***TEST CASE 2: 1-APPLET 1 IS NOT TRIGGERED***
        test.envelopeEventDownloadBrowserTermination();
        //***TEST CASE 2: 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_BROWSER_TERMINATION ***
