...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.catre.cre_tin_prlv_4;
...
public class Cre_Tin_Prlv_4 extends TestToolkitApplet
{
     ...
     */
    public Cre_Tin_Prlv_4() 
    {
		Cre_Tin_Prlv_4.bNbInstance ++;
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Cre_Tin_Prlv_4 thisApplet = new Cre_Tin_Prlv_4();
    ...
    public void processToolkit(short event) 
    {
		...
		// -----------------------------------------------------------------
		//		 Instance 1 execution, Priority Level 7F
		// -----------------------------------------------------------------
		...
		// -----------------------------------------------------------------
		//		 Instance 2 execution, Priority Level 80
		// -----------------------------------------------------------------
