...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.catre.cre_tin_prlv_2;
...
public class Cre_Tin_Prlv_2 extends TestToolkitApplet
{
     ...
     */
    public Cre_Tin_Prlv_2() 
    {
		Cre_Tin_Prlv_2.bNbInstance ++;
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Cre_Tin_Prlv_2 thisApplet = new Cre_Tin_Prlv_2();
