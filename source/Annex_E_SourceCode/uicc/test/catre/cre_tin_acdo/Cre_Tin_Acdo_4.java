...
public class Cre_Tin_Acdo_4 extends TestToolkitApplet
{ 
    ...
    public static void install(byte bArray[], short bOffset, byte bLength)
    {
        ...
        Cre_Tin_Acdo_4 thisApplet = new Cre_Tin_Acdo_4();
    ...
    public void processToolkit(short event)
    {
        ...
        // -----------------------------------------------------------------
        //  Test Case 4 : Global PIN2 access right Applet
        // -----------------------------------------------------------------
        ...
        if (event == EVENT_MENU_SELECTION) {
            ...
            {
                if (bARRNb != 4)
                    // Security exception is expected, except on EFCARR4 
            ...
            {
                if (bARRNb != 4)
                    // Security exception is expected, except on EFLARR4 
            ...
            {
                if (bARRNb != 4)
                    // Security exception is expected, except on EFTARR4 
            ...
            if (bMenuId == 2)
            {
                ...
                {
                    if (bARRNb != 4)
                        // Security exception is expected, except on EFTAR4T 
