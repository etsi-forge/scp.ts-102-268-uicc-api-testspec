...
public class Cre_Tin_Acdo_3 extends TestToolkitApplet
{ 
    ...
    public static void install(byte bArray[], short bOffset, byte bLength)
    {
        ...
        Cre_Tin_Acdo_3 thisApplet = new Cre_Tin_Acdo_3();
    ...
    public void processToolkit(short event)
    {
        ...
        // -----------------------------------------------------------------
        //  Test Case 3 : Always access right Applet
        // -----------------------------------------------------------------
        ...
        if (event == EVENT_MENU_SELECTION) {
            ...
            {
                if (bARRNb != 1)
                    // Security exception is expected, except on EFCARR1 
            ...
            {
                if (bARRNb != 1)
                    // Security exception is expected, except on EFLARR1 
            ...
            {
                if (bARRNb != 1)
                    // Security exception is expected, except on EFTARR1 
            ...
            if (bMenuId == 2)
            {
                ...
                {
                    if (bARRNb != 1)
                        // Security exception is expected, except on EFTAR1T 
