...
public class Cre_Tin_Acdo_6 extends TestToolkitApplet
{ 
    ...
    public static void install(byte bArray[], short bOffset, byte bLength)
    {
        ...
        Cre_Tin_Acdo_6 thisApplet = new Cre_Tin_Acdo_6();
    ...
    public void processToolkit(short event)
    {
        ...
        // -----------------------------------------------------------------
        //  Test Case 3 : Local PIN & ADM2 access right Applet
        // -----------------------------------------------------------------
        ...
        if (event == EVENT_MENU_SELECTION) {
            ...
            {
                if (bARRNb != 5)
                    // Security exception is expected, except on EFCARR5 
            ...
            {
                if (bARRNb != 5)
                    // Security exception is expected, except on EFLARR5 
            ...
            {
                if (bARRNb != 5)
                    // Security exception is expected, except on EFTARR5 
            ...
            if (bMenuId == 2)
            {
                ...
                {
                    if (bARRNb != 5)
                        // Security exception is expected, except on EFTAR5T 
