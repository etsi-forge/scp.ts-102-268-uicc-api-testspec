...
//    Package Definition
//-----------------------------------------------------------------------------
package uicc.test.catre.cre_tin_prlv_7;
...
public class Cre_Tin_Prlv_7 extends TestToolkitApplet
{
     ...
     */
    public Cre_Tin_Prlv_7() 
    {
		Cre_Tin_Prlv_7.bNbInstance ++;
    ...
    public static void install(byte bArray[], short bOffset, byte bLength) 
    {
        ...
        Cre_Tin_Prlv_7 thisApplet = new Cre_Tin_Prlv_7();
