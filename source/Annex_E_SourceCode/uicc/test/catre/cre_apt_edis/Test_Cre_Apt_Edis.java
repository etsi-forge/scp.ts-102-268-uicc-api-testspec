...
public class Test_Cre_Apt_Edis extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/catre/cre_apt_edis";
    ...
    public boolean run() {
        ...
        // test script
        test.reset();
        test.terminalProfileSession("09010000 41");
        //***TEST CASE 1: 1-APPLET 1 IS REGISTERED TO EVENT_EVENT_DOWNLOAD_IDLE_SCREEN_AVAILABLE ***
        //***TEST CASE 1: 2-APPLET 1 IS TRIGGERED***
        test.envelopeEventDownloadIdleScreenAvailable();
