 ...
 * buildTLVHandler(byte type, short capacity) method
 */
//-----------------------------------------------------------------------------
//    Package Definition
//-----------------------------------------------------------------------------
...
public class Test_Api_3_Hbd_Bthdbs extends UiccTestModel {

    static final String CAP_FILE_PATH = "uicc/test/system/api_3_hbd_bthdbs";
    ...
    public boolean run() {
        ...
        test.addResult(response.checkData("10" + APPLET_AID_1 + "05CCCC CCCCCC"));
